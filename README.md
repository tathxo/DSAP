...
## How does it work?
See the [Game Page](/apworld/dsr/docs/en_Dark%20Souls%20Remastered.md).
## Setting up?
See the [Setup Guide](/apworld/dsr/docs/setup_en.md).
## Looking for Releases?
See the [Releases Page](https://github.com/ArsonAssassin/DSAP/releases/latest).  
`dsr.apworld` is the apworld.  
`dsr-Windows-x64.zip` contains the client.
