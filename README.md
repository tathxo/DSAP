...
* Run the game, and **load into your save file**.
* With both the Archipelago server and game running, Open the client folder you unzipped earlier and run DSAP.Desktop.exe.
* Fill in your host, slot and password (if required) and press Connect. This will cause your game to reload.
* You should now be ready to play.

# Known issues
* If you receive an item while on the main menu, it may get lost, requiring admin intervention. For safety, you should run the client once loaded into game.
  * Furthermore, you should close the client before quitting to menu or quitting the game.
* Deathlink has not been thoroughly tested.
