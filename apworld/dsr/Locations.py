...
"Demon Ruins - Ceaseless Discharge": [
    ...
    DSRLocationData(11110410, f"DR: Soul of a Proud Knight - Ceased Discharge", f"Soul of a Proud Knight", DSRLocationCategory.ITEM_LOT), # Item spawns only after Ceaseless gets defeated
    DSRLocationData(11110412, f"DR: Demon Ruins - Burrowing Rockworm Bonfire", f"Bonfire Warp Unlock - Demon Ruins - Burrowing Rockworm", DSRLocationCategory.BONFIRE), # Spawns only after Ceaseless
],
"Demon Ruins": [
